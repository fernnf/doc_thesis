...
\title{A Scalable Network Virtualization Architecture in Software Defined Network Using Virtual Switch}
...
\author[inst1]{Fernando N. N. Farias}
\ead{fernnf@ufpa.br}
\author[inst1]{Ant\^{o}nio J. G. Abel\'{e}m}
\ead{abelem@ufpa.br}

\address[inst1]{The Computer Science Post-Graduate Program\\ Federal University of Par\'{a} -- UFPA }
...
\begin{keyword}
Network Virtualization \sep Software-Defined Network \sep Switch Virtualization \sep Slice 
...
Network virtualization (NV) have attracted a lot of highlights as an essential solution for network computing. The NV has been a main keyword among networking researchers and manufacturer for describing virtualization solutions based on virtual private networks, overlay networks, and programmable networks.
